...
export function createURLWithBaseUntrustable(url, base) {
...
export function getRequestedURL(req) {
    return createURLWithBaseUntrustable(req.url, getMyBaseURL(req));
}
...
export function sendError(
    ...
    // If a video vanished, it might just be vanished forever
    if (code != 404) res.setHeader("Cache-Control", "private, no-cache");
    else res.setHeader("Cache-Control", "s-maxage=10800");
        ...
        default:
            ...
            minify(
                render(ERROR_TEMPLATE, {
                    ...
                    dataShort: shortenDescription(errorData.data, 300, false),
